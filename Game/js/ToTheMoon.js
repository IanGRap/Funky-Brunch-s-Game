...
ToTheMoonConversations = [
    ...
    function(){dialogue('Xperiment, it\'s not cool to let someone die because you don\'t want to share.', aX, aY, 'speachR', ToTheMoonConversations[++index], 1);},
    ...
    function(){dialogue('They all live together in a fancy castle and argue how to use our rockets!', aX, aY, 'speachR', ToTheMoonConversations[++index], 1);},
